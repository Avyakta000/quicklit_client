    ...
    <div className="bg-gray-800 min-h-screen flex flex-col mx-auto justify-center max-w-4xl">
      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="p-6 border rounded-lg shadow-md">
          ...
          <h2 className="text-2xl font-semibold text-blue-500 mt-6 mb-4">Ownership and Copyright</h2>
          <p className="text-lg text-gray-400 mb-4">
          ...
          <h2 className="text-2xl font-semibold text-blue-500 mt-6 mb-4">Educational Purposes</h2>
          <p className="text-lg text-gray-400 mb-4">
          ...
          <h2 className="text-2xl font-semibold text-blue-500 mt-6 mb-4">Limitations of Liability</h2>
          <p className="text-lg text-gray-400 mb-4">
          ...
          <h2 className="text-2xl font-semibold text-blue-500 mt-6 mb-4">Contact Us</h2>
          <p className="text-lg text-gray-400 mb-4">
