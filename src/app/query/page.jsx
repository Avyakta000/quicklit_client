...
const DynamicPageContent = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 min-h-[calc(100vh-68px)] mb-8">
      <h1 className="text-2xl font-bold text-gray-200 mt-6 mb-4 border-b py-2">
        Reads for <span className="text-gray-400">{value}</span>
      </h1>
...
const DynamicPage = () => (
  <Suspense fallback={<p className="text-gray-200">Loading page...</p>}>
    <DynamicPageContent />
  </Suspense>
);
...
// 'works correctly except build error suspense boundary'
// "use client";
